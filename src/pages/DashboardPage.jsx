    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted">Dein Überblick auf einen Blick</p>
        </div>
          ...
          {overdue.length > 0 && (
            <Card>
              <div className="mb-3 flex items-center gap-2 text-rose-400">
                ...
                <h3 className="font-medium text-primary">Überfällig ({overdue.length})</h3>
              </div>
              ...
              <Link to="/app/tasks?quick=overdue" className="mt-2 inline-block text-xs text-indigo-400 hover:underline">
                Alle anzeigen
              </Link>
            </Card>
          )}
          {today.length > 0 && (
            <Card>
              <div className="mb-3 flex items-center gap-2 text-indigo-400">
                ...
                <h3 className="font-medium text-primary">Heute ({today.length})</h3>
              </div>
              <ul className="space-y-2">
