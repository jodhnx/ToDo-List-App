export const SHOPPING_CATEGORIES = [
  {
    ...
    products: ['Tomaten', 'Gurke', 'Kartoffeln', 'Äpfel', 'Bananen', 'Karotten', 'Salat', 'Zwiebeln', 'Paprika', 'Orangen', 'Birnen', 'Zitronen'],
  },
  {
    id: 'dairy-bakery',
    label: 'Milch- & Backwaren',
    color: 'border-amber-300/40 bg-amber-500/10 text-amber-100',
    products: ['Milch', 'Brot', 'Brötchen', 'Butter', 'Joghurt', 'Käse', 'Eier', 'Sahne', 'Toast', 'Quark', 'Frischkäse', 'Croissants'],
  },
  {
    id: 'frozen',
    label: 'Tiefkühlprodukte',
    color: 'border-sky-300/40 bg-sky-500/10 text-sky-100',
    products: ['Pizza', 'Gemüse', 'Pommes', 'Fischstäbchen', 'Eis', 'Beeren', 'Spinat', 'Lasagne', 'Hähnchen Nuggets', 'Kräuter'],
  },
  {
    id: 'meat',
    label: 'Fleisch / Aufschnitt',
    color: 'border-rose-300/40 bg-rose-500/10 text-rose-100',
    products: ['Hähnchen', 'Hackfleisch', 'Schinken', 'Salami', 'Würstchen', 'Speck', 'Putenbrust', 'Leberkäse', 'Bratwurst', 'Schnitzel'],
  },
  {
    id: 'basics',
    label: 'Basics',
  ...
  },
  {
    ...
    products: ['Snacks', 'Schokolade', 'Gewürze', 'Kerzen', 'Batterien', 'Chips', 'Kekse', 'Nüsse', 'Kaugummi'],
  },
  {
    id: 'household',
    label: 'Haushaltswaren',
    color: 'border-cyan-300/40 bg-cyan-500/10 text-cyan-100',
    products: ['Küchenrolle', 'Toilettenpapier', 'Spülmittel', 'Waschmittel', 'Müllbeutel', 'Alufolie', 'Backpapier', 'Schwämme', 'Reiniger', 'Geschirrspültabs'],
  },
  {
    id: 'hygiene',
    label: 'Hygiene',
    color: 'border-pink-300/40 bg-pink-500/10 text-pink-100',
    products: ['Zahnpasta', 'Duschgel', 'Shampoo', 'Seife', 'Deo', 'Taschentücher', 'Wattestäbchen', 'Creme', 'Rasierer', 'Mundspülung'],
  },
]
