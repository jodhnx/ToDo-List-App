...
3. Falls Tabelle schon existiert → `migration_v2.sql`, `migration_v3_due_time.sql`, `migration_v4_families.sql`, `migration_v4_families_fix.sql`, `migration_v5_roles.sql`, `migration_v6_shopping_items.sql`, `migration_v7_group_shopping_items.sql`, `migration_v8_task_reminders.sql`, `migration_v9_group_management.sql`
...
supabase/       schema.sql, migration_v2–v9
```
